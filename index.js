...
function playerNumbers(teamName) {
    let game = gameObject();
    let numbers = [];
    for (let player in game[teamName].players) {
        numbers.push(game[teamName].players[player].number);
    }
    return numbers;
}
...
console.log(playerNumbers("home"));  // [ 0, 30, 11, 1, 31 ]
console.log(playerStats("Alan Anderson"));  // Object containing Alan Anderson's stats
